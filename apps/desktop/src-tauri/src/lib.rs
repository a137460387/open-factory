...
pub fn run() -> Result<(), Box<dyn std::error::Error>> {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::ffmpeg::run_post_export_quality_assurance,
            ...
            commands::collaboration::start_collaboration_host,
            commands::collaboration::stop_collaboration_host,
            commands::collaboration::broadcast_collaboration_message,
            ...
            commands::scene::detect_glitches,
            commands::secrets::read_translation_api_key,
            commands::secrets::write_translation_api_key,
            commands::secrets::read_smtp_password,
            commands::secrets::write_smtp_password,
            commands::publish::send_smtp_email,
            commands::publish::post_webhook_json,
            ...
            commands::video_gen::save_video_gen_task,
            commands::video_gen::list_video_gen_tasks,
            commands::video_gen::update_video_gen_task_status,
            commands::video_gen::delete_video_gen_task,
            commands::video_gen::cleanup_video_gen_tasks,
            get_app_version,
            check_for_updates,
            run_migrations,
        ])
