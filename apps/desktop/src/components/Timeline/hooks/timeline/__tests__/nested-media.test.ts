...
import { PackNestedSequenceCommand, ReplaceMediaCommand, SwitchMediaVersionCommand } from '@open-factory/editor-core';

const { executeMock, showToastMock, openFileDialogMock, probeMediaPathMock, editorStoreState } = vi.hoisted(() => ({
  executeMock: vi.fn(),
  showToastMock: vi.fn(),
