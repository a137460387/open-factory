...
export const AutomationEditor: React.FC<AutomationEditorProps> = ({
  ...
  const getMousePos = useCallback((e: React.MouseEvent | MouseEvent): { time: number; value: number } => {
  ...
  const handleChangePointCurve = useCallback((type: AutomationPoint['curve']) => {
