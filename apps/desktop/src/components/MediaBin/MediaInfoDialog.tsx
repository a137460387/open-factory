...
import { formatBytes, formatBitRate, formatDateTime } from './media-bin-utils';

export type MediaInfoState = { asset: MediaAsset; loading: boolean; analysis?: MediaAnalysis; error?: string };
export type MediaSourcePathsState = { asset: MediaAsset; paths: string[] };

export function MediaSourcePathsDialog({ state, onClose }: { state: MediaSourcePathsState; onClose(): void }) {
