...
import {KEYFRAME_PROPERTY_LIMITS, applyKeyframeHandlePatch, getPresetHandles} from '@open-factory/editor-core';
import type {KeyframeProperty} from '@open-factory/editor-core';
import {zhCN} from '../../i18n/strings';
import {type SelectedKeyframeRef} from '../../store/editorStore';
import {roundFinite} from './curveEditorUtils';
import {
  type CanvasPoint,
  ...
  nextHandleMode,
} from './keyframeCurveHelpers';
import {EasingPresetSelector} from './EasingPresetSelectorModule';
