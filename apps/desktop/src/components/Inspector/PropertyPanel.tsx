    ...
    <>
      ...
      {clip.type === 'text' || clip.type === 'subtitle' || clip.type === 'credits' ? (
        ...
        >
          ...
          {clip.type === 'subtitle' ? <SubtitleDetailsPanel {...props} /> : null}
          {clip.type === 'text' ? (
            <TextAdvancedPanel
              clip={clip}
              ...
              textOpenTypeFeatures={textOpenTypeFeatures}
              textArc={textArc}
              textAnimationPreset={textAnimationPreset}
              setTextAnimationPreset={setTextAnimationPreset}
              textAnimationDuration={textAnimationDuration}
              setTextAnimationDuration={setTextAnimationDuration}
              textAnimationDirection={textAnimationDirection}
              setTextAnimationDirection={setTextAnimationDirection}
              textAnimationKeyframeCount={textAnimationKeyframeCount}
              commit={commit}
              addKeyframe={addKeyframe}
              updateTextPath={updateTextPath}
              updateTextLayout={updateTextLayout}
              updateTextOpenTypeFeatures={updateTextOpenTypeFeatures}
              updateTextArc={updateTextArc}
  ...
  return (
    <>
      ...
      >
        ...
        <div className="space-y-2 border-t border-line p-2">
          <TextAreaField
            ...
            value={subClip.dataSubtitle?.template ?? subClip.text}
          ...
          >
            {subClip.dataSubtitle
              ? zhCN.inspector.dataSubtitle.summary(subClip.dataSubtitle.sourceType, subClip.dataSubtitle.rows.length)
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <button
              className="rounded-md border border-line bg-[var(--color-bg-elevated)] px-2 py-1.5 text-sm font-medium hover:bg-panel disabled:cursor-not-allowed disabled:opacity-50"
              type="button"
              disabled={selectedClipLocked || !subClip.dataSubtitle}
      ...
      <ColorField
        ...
        value={subClip.style.outlineColor}
      ...
      <NumberField
        ...
        value={subClip.style.outlineWidth}
        min={0}
        max={12}
        step={1}
      ...
      <SubtitleProofreadingPanel
        clip={subClip}
        selectedSubtitleClips={selectedSubtitleClips.length > 0 ? selectedSubtitleClips : [subClip]}
        selectedClipLocked={selectedClipLocked}
