...
import {KEYFRAME_PROPERTY_LIMITS, applyKeyframeHandlePatch, calculateBezierHandleCoordinates, calculateKeyframeSpeedSamples, createId, interpolateKeyframes} from '@open-factory/editor-core';
