...
export function ProjectEncryptionSaveDialog({
  ...
  return (
    <div
      ...
      data-testid="project-encryption-dialog"
    >
      <form
      ...
      >
        ...
        <div className="flex justify-end gap-2 border-t border-line px-4 py-3">
          <button
            ...
            type="button"
            onClick={onClose}
            data-testid="project-encryption-cancel-button"
          >
            {zhCN.common.cancel}
          </button>
          <button
            ...
            data-testid="project-encryption-confirm-button"
          >
            {t.encryptedConfirm}
          </button>
        </div>
