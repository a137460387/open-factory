        ...
        {reviewMode ? (
          ...
          <>
            ...
            <select
              ...
              onPointerDown={props.onSnapshotPointerDown}
              onFocus={props.onSnapshotPointerDown}
              onChange={(e) => props.onSnapshotCompareSelect(e.target.value)}
            >
            ...
            {compareEnabled ? (
              ...
              >
                <button
                  ...
                  onClick={() => props.onCompareModeChange('left-right')}
                >
                  <Columns2 size={16} />
                </button>
                <button
                  ...
                  onClick={() => props.onCompareModeChange('top-bottom')}
                >
                  <Rows2 size={16} />
                </button>
                <button
                  ...
                  onClick={() => props.onCompareModeChange('difference')}
                >
                  <Blend size={16} />
                </button>
              </div>
            ...
            <button
              className={`inline-flex h-9 w-9 items-center justify-center rounded-md border border-white/10 text-white hover:bg-white/20 ${canvasEditMode ? 'bg-emerald-500/25' : 'bg-white/10'}`}
              ...
              onClick={props.onToggleCanvasEditMode}
            >
              <MousePointer2 size={17} />
            </button>
            <button
              className={`inline-flex h-9 w-9 items-center justify-center rounded-md border border-white/10 text-white hover:bg-white/20 ${frameInspectMode ? 'bg-emerald-500/25' : 'bg-white/10'}`}
              ...
              onClick={props.onToggleFrameInspectMode}
            >
              <Pipette size={17} />
            </button>
            <button
              className={`inline-flex h-9 w-9 items-center justify-center rounded-md border border-white/10 text-white hover:bg-white/20 ${compareEnabled ? 'bg-emerald-500/25' : 'bg-white/10'}`}
            ...
            <button
              className={`inline-flex h-9 w-9 items-center justify-center rounded-md border border-white/10 text-white hover:bg-white/20 ${scopesOpen ? 'bg-emerald-500/25' : 'bg-white/10'}`}
              title={t.colorScopes}
              aria-label={t.colorScopes}
              data-testid="toggle-color-scopes"
              onClick={props.onToggleScopes}
            >
              <BarChart3 size={17} />
            </button>
            <button
