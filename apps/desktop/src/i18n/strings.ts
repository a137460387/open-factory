...
usageCount: (n: number) => `共 ${n} 次调用`,      usageStatsTitle: 'AI 使用统计',
  ...
  musicMatch: {
    ...
    selectProvider: '选择服务商',
    startAnalysis: '开始分析',
    audioLoopInfo: (loops: number, trim: number) =>
      `循环 ${loops} 次，裁剪 ${trim.toFixed(1)}s`,
  },
  highlightReel: {
    title: 'AI精彩集锦',
    configTitle: '集锦配置',
...
const enOverrides = {
  ...
  settings: {
    ...
    general: {
      ...
      localCoeditingLanWarning: 'LAN mode allows other devices on the same network to connect via this port. Make sure the network is trusted.',
    ...
    hardwareAcceleration: {
      ...
      description: 'Configure hardware acceleration for video preview decoding, significantly improving playback performance for high-bitrate 4K/8K footage.',
      modeTitle: 'Acceleration Mode',
      modeDescription: 'Choose the hardware acceleration strategy.',
      modeAuto: 'Auto',
      modeAutoDescription: 'Auto-detect available hardware acceleration, prefer GPU decoding, fall back to software when unavailable.',
      ...
      preferredBackendDescription: 'Choose the preferred hardware acceleration backend. Auto mode tries in priority order.',
      backendAuto: 'Auto',
      backendCuda: 'CUDA (NVIDIA)',
      backendVaapi: 'VAAPI (AMD/Intel Linux)',
      backendQuickSync: 'QuickSync (Intel)',
  ...
  exportDialog: {
    ...
    postExportScript: {
      ...
      confirmMessage: 'Please verify the command below is safe before running. The script executes directly with current user permissions (no shell).',
