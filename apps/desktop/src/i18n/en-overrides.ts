...
export const enOverrides = {
  ...
  toolbar: {
    ...
    collaborationPanel: 'Collaboration Session',
  ...
  settings: {
    ...
    taskMonitor: {
      ...
      backgroundConcurrencyAuto: 'Auto',
      uiFeedbackConcurrency: 'Preview Feedback Concurrency',
      pause: 'Pause Queue',
      resume: 'Resume Queue',
      priority: 'Priority',
      priorityHigh: 'High',
  ...
  collabPanel: {
    ...
    locked: 'Locked',
    lockedBy: (userName: string) => `Locked (${userName})`,
    notLocked: 'Not Locked',
    readonlyNotice: 'You are a viewer. Color grading parameters are read-only and cannot be modified.',
  },
  complexity: {
