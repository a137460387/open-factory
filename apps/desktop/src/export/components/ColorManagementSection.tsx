import { normalizeExportColorManagement, EXPORT_COLOR_SPACES, type ExportColorSpace } from '@open-factory/editor-core';
...
import { updateColorManagement } from '../lib/exportSettingsHelpers';
