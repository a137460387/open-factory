...
const mockUIState = {
  ...
  videoGenerationOpen: false,
  mediaHealthDashboardOpen: false,
  setBatchTranscodeOpen: vi.fn(),
  setBatchWatermarkOpen: vi.fn(),
  setBatchProjectProcessingOpen: vi.fn(),
  setLutEditorOpen: vi.fn(),
  setColorNodeEditorOpen: vi.fn(),
  setColorAnalysisOpen: vi.fn(),
  setProfessionalNleExportOpen: vi.fn(),
  setMediaPrecheckOpen: vi.fn(),
  setVideoStitchWizardOpen: vi.fn(),
  setSmartMontageOpen: vi.fn(),
  setSyncCompareOpen: vi.fn(),
  setSceneReorderOpen: vi.fn(),
  setStyleTransferOpen: vi.fn(),
  setCollaborationNotesOpen: vi.fn(),
  setCollaborationPanelOpen: vi.fn(),
  setColorGradingWorkspaceOpen: vi.fn(),
  setOperationRecordingOpen: vi.fn(),
  setComplexityScoreOpen: vi.fn(),
  setSmartRecommendationsOpen: vi.fn(),
  setContentAnalysisOpen: vi.fn(),
  setProfilerOpen: vi.fn(),
  setRhythmAnalysisOpen: vi.fn(),
  setAutoAudioSyncOpen: vi.fn(),
  setErrorKnowledgeOpen: vi.fn(),
  setSequenceCompareOpen: vi.fn(),
  setSubtitleSyncOpen: vi.fn(),
  setProxyVerifyOpen: vi.fn(),
  setFormatConverterOpen: vi.fn(),
  setEmotionAnalysisOpen: vi.fn(),
  setExportHistoryClassifierOpen: vi.fn(),
  setMacroHistoryOpen: vi.fn(),
  setAiChatEditorOpen: vi.fn(),
  setAiRoughCutOpen: vi.fn(),
  setBeatSyncOpen: vi.fn(),
  setContextualTranslationOpen: vi.fn(),
  setDirectorModeOpen: vi.fn(),
  setDuplicateMediaOpen: vi.fn(),
  setHighlightReelOpen: vi.fn(),
  setHistoryPanelOpen: vi.fn(),
  setMediaOrganizerOpen: vi.fn(),
  setMusicMatchOpen: vi.fn(),
  setNarrationOpen: vi.fn(),
  setPasteKeyframeDialogOpen: vi.fn(),
  setPreviewWindowOpen: vi.fn(),
  setProjectDocumentationOpen: vi.fn(),
  setProjectEncryptionSaveOpen: vi.fn(),
  setProjectHealthOpen: vi.fn(),
  setProjectTemplateOpen: vi.fn(),
  setReleaseWorkflowOpen: vi.fn(),
  setReviewMode: vi.fn(),
  setShortcutCheatsheetOpen: vi.fn(),
  setSmartCreationOpen: vi.fn(),
  setSmartRoughCutOpen: vi.fn(),
  setSnapshotCompareOpen: vi.fn(),
  setSnapshotHistoryOpen: vi.fn(),
  setSnapshotNameOpen: vi.fn(),
  setStoryboardOpen: vi.fn(),
  setTimelineCompareOpen: vi.fn(),
  setTimelineSearchOpen: vi.fn(),
  setVideoSummaryOpen: vi.fn(),
  setVideoGenerationOpen: vi.fn(),
  setSettingsOpen: vi.fn(),
  setAssistEditingOpen: vi.fn(),
  setContentGenerationOpen: vi.fn(),
  setQualityAssessmentOpen: vi.fn(),
  ...
  languageVersion: 1,
  persistLayoutPatch: vi.fn(),
  persistPanelVisibilityPatch: vi.fn(),
};
...
const mockSettingsState = {
  ...
  setPiPLayoutPosition: vi.fn(),
  customSplitLayouts: [],
  setCustomSplitLayouts: vi.fn(),
  beatSensitivity: 0.5,
  setBeatSensitivity: vi.fn(),
  beatSyncSpeedEnabled: false,
  setBeatSyncSpeedEnabled: vi.fn(),
  beatSyncManualBpm: null,
  setBeatSyncManualBpm: vi.fn(),
  sceneDetectionRequestId: null,
  setSceneDetectionRequestId: vi.fn(),
  collaborationIdentity: { name: 'User', color: '#ff0000' },
  setCollaborationIdentity: vi.fn(),
  tutorialProgress: { tutorialStep: 0 },
  ...
  setSafeFrameGuides: vi.fn(),
  thumbnailTrackVisible: true,
  setThumbnailTrackVisible: vi.fn(),
  timelineMinimapVisible: true,
  setTimelineMinimapVisible: vi.fn(),
  timelineHeatmap: { enabled: false },
  setTimelineHeatmap: vi.fn(),
  previewPerformance: { qualityMode: 'auto' },
  ...
  setAutosaveIntervalSeconds: vi.fn(),
};
...
const mockFeatureState = {
  ...
  setColorAnalysisBusy: vi.fn(),
  colorAnalysisResults: null,
  setColorAnalysisResults: vi.fn(),
  colorAnalysisJumps: null,
  setColorAnalysisJumps: vi.fn(),
  colorHeatmapPoints: [],
  setColorHeatmapPoints: vi.fn(),
  colorAnalysisSamples: null,
  setColorAnalysisSamples: vi.fn(),
  setGifExportAsset: vi.fn(),
  setSpectrumAsset: vi.fn(),
  mediaVersionCompare: null,
  setMediaVersionCompare: vi.fn(),
  ...
  setAudioSeparationClipId: vi.fn(),
  audioSeparationProgress: 0,
  setAudioSeparationProgress: vi.fn(),
  speakerDiarizationRunning: false,
  setSpeakerDiarizationRunning: vi.fn(),
  speakerDiarizationResult: null,
  setSpeakerDiarizationResult: vi.fn(),
  autoAudioSyncRunning: false,
  setAutoAudioSyncRunning: vi.fn(),
  autoAudioSyncPrimaryClipId: null,
  setAutoAudioSyncPrimaryClipId: vi.fn(),
  autoAudioSyncMode: 'waveform',
  setAutoAudioSyncMode: vi.fn(),
  autoAudioSyncResults: null,
  setAutoAudioSyncResults: vi.fn(),
  recordingTask: null,
  setRecordingTask: vi.fn(),
  ...
  projectHealthRepairReport: null,
  mediaHealthScanning: false,
  mediaHealthDashboard: null,
  mediaHealthAutoShowEnabled: false,
  setMediaHealthAutoShowEnabled: vi.fn(),
  setMediaHealthDashboard: vi.fn(),
  setMediaHealthScanning: vi.fn(),
  contentAnalysisRunningClipId: null,
  ...
  mediaOrganizerCleanup: null,
  setMediaOrganizerCleanup: vi.fn(),
  mediaOrganizerScanning: false,
  setMediaOrganizerScanning: vi.fn(),
  pasteKeyframeDialogGroups: [],
  setPasteKeyframeDialogGroups: vi.fn(),
  projectPasswordRequest: null,
  setProjectPasswordRequest: vi.fn(),
  ...
  timelineTemplateMode: false,
  setTimelineTemplateMode: vi.fn(),
