...
vi.mock('../../lib/ui-helpers', () => ({
  ...
  isEditableKeyboardEventTarget: vi.fn(() => false),
  getWorkspaceLayoutDisplayName: vi.fn(() => ''),
}));
vi.mock('../../lib/toast', () => ({ showToast: vi.fn() }));
vi.mock('../../settings/appSettings', () => ({ saveLayoutSettings: vi.fn() }));
vi.mock('../../layout/layoutSettings', () => ({
  applyWorkspaceLayout: vi.fn(),
  getWorkspaceLayoutById: vi.fn(),
  resolveWorkspaceLayoutShortcut: vi.fn(() => null),
}));
vi.mock('../../accessibility/keyboard-navigation', () => ({
  isEditableKeyboardTarget: vi.fn(() => false),
  isShortcutCheatsheetKey: vi.fn(() => false),
}));
