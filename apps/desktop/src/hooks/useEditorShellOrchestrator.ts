...
export function useEditorShellOrchestrator(
  ...
  const {
    ...
    setLayoutSettings: store.setLayoutSettings,
  });
  ...
  const {
    ...
    setSelectedClipIds: store.setSelectedClipIds,
    setPlayheadTime: store.setPlayheadTime,
    setVideoStitchWizardOpen: store.setVideoStitchWizardOpen,
    setExportDialogOpen: exportQueue.setExportDialogOpen,
    setTemplateExportPreset: store.setTemplateExportPreset,
    persistMediaFingerprints,
    queueFrameRateConversionForImportedMedia,
    runAutomationForMedia,
    ...
    setRecoveryCandidate: store.setRecoveryCandidate,
    applyImportedMediaColorConversionChoice,
    togglePlayback,
    reversePlayback,
    pausePlayback,
    ...
    splitSelected,
    selectAllTimelineItems,
    clearSelectedClipIds: store.clearSelectedClipIds,
    addAnnotationAtPlayhead,
    addBookmarkAtPlayhead,
    toggleTimelineGridSnap,
    jumpTimelineNavigationPoint,
    ...
    redo,
    saveProject,
    exportCurrentFrame: exportQueue.exportCurrentFrame,
    matchFrameToSource,
    revealMediaInTimeline,
    navigateToNextInstance,
    navigatePrevGap,
  ...
  const {
    ...
    selectedClipMedia: derived.selectedClipMedia,
    addMedia: store.addMedia,
    setSelectedClipId: store.setSelectedClipId,
    setSelectedClipIds: store.setSelectedClipIds,
    demucsAvailability: store.demucsAvailability,
    demucsExecutablePath: store.demucsExecutablePath,
    audioSeparationClipId: store.audioSeparationClipId,
    speakerDiarizationTarget: derived.speakerDiarizationTarget,
    speakerDiarizationResult: store.speakerDiarizationResult,
    autoAudioSyncTargets: derived.autoAudioSyncTargets,
    resolvedAutoAudioSyncPrimaryClipId: derived.resolvedAutoAudioSyncPrimaryClipId,
    autoAudioSyncResults: store.autoAudioSyncResults,
    autoAudioSyncMode: store.autoAudioSyncMode,
    project: store.project,
  });
  ...
  const { startEditorRecording, stopEditorRecording } = useRecordingCallbacks({
    addMedia: store.addMedia,
    persistMediaFingerprints,
    recordingTask: store.recordingTask,
    recordingSettings: store.recordingSettings,
  });
  ...
  const { detectSelectedBeats, snapSelectedToBeats, splitSelectedToBeats, applyManualBeatBpm } = useBeatSyncCallbacks({
    ...
    selectedClipIds: store.selectedClipIds,
    beatSyncBeatTimes: derived.beatSyncBeatTimes,
    beatSyncSpeedEnabled: store.beatSyncSpeedEnabled,
    beatSyncManualBpm: store.beatSyncManualBpm,
    beatSensitivity: store.beatSensitivity,
  ...
  const { leftPanelCallbacks } = useEditorShellPanelCallbacks({
    ...
    setGifExportAsset: store.setGifExportAsset,
    setSpectrumAsset: store.setSpectrumAsset,
    scanDuplicateMedia,
    addAssetToTimeline,
    addVersionForMedia,
    openMediaVersionCompare,
    ...
    generateProxyForMedia,
    convertVfrMediaToCfr,
    setMediaMetadata: store.setMediaMetadata,
    batchUpdateMediaMetadata,
    batchRenameMedia,
    addTitleTemplate,
    createMediaFolder,
    ...
    handleDeleteSubclip,
    handleAddSubclipToTimeline,
    projectMediaMetadata: store.project.mediaMetadata,
  });

  // Floating dialogs
  const { floatingDialogsCallbacks } = useEditorShellFloatingDialogsCallbacks({
    templateExportPreset: store.templateExportPreset,
    exportDialogOpen: exportQueue.exportDialogOpen,
    setExportDialogOpen: exportQueue.setExportDialogOpen,
    timelineExportDialogOpen: exportQueue.timelineExportDialogOpen,
    setTimelineExportDialogOpen: exportQueue.setTimelineExportDialogOpen,
    lastExportPath: exportQueue.lastExportPath,
    setLastExportPath: exportQueue.setLastExportPath,
    setTutorialSignals: store.setTutorialSignals,
    runAutomationForMedia,
    relinkAllMissing,
    importEdlTimeline,
    ...
    createProjectFromTimelineTemplate,
    colorAnalysisResults: store.colorAnalysisResults,
    colorAnalysisJumps: store.colorAnalysisJumps,
    colorAnalysisBusy: store.colorAnalysisBusy,
    runTimelineColorAnalysis,
    alignTimelineColorToReference,
    seekSpectrumTime,
    ...
    operationRecording: store.operationRecording,
    operationRecordingActive: store.operationRecordingActive,
    operationReplayRunning: store.operationReplayRunning,
    operationRecordingStep: store.operationRecordingStep,
    operationReplaySpeed: store.operationReplaySpeed,
    startOperationRecording,
    stopOperationRecording,
    saveOperationRecording,
    loadOperationRecording,
    ...
    jumpOperationRecording,
    exportOperationRecordingSlides,
    profilerRecording: store.profilerRecording,
    profilerElapsedMs: store.profilerElapsedMs,
    ...
    applySnapshotDiffSelection,
    updateProjectReleaseVersion,
    syncCompareClipRefs: derived.syncCompareClipRefs,
    jumpToMediaAsset,
    detectedBeatBpm: derived.detectedBeatBpm,
    beatSyncBeatTimes: derived.beatSyncBeatTimes,
    canDetectBeats: derived.canDetectBeats,
    canSnapToBeats: derived.canSnapToBeats,
    applyManualBeatBpm,
    detectSelectedBeats,
    snapSelectedToBeats,
    updatePreviewPerformance,
    ...
    archiveUnusedMedia,
    renameUnusedMedia,
    recoveryCandidate: store.recoveryCandidate,
    exportQueueRecovery: exportQueue.exportQueueRecovery,
    archiveProgress: store.archiveProgress,
    sharePackageProgress: exportQueue.sharePackageProgress,
    restoreRecovery,
    discardRecovery,
