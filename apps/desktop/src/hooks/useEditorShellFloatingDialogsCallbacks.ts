...
interface FloatingDialogsDeps {
  ...
  runAutomationForMedia: (trigger: string, media: any[]) => void;
  ...
  createProjectFromTimelineTemplate: (templateId: string) => void;
  colorAnalysisResults: any;
  colorAnalysisJumps: any;
  colorAnalysisBusy: boolean;
  runTimelineColorAnalysis: () => void;
  alignTimelineColorToReference: () => void;
  seekSpectrumTime: (time: number) => void;
  setSpectrumSelectionRange: (range: { start: number; end: number }) => void;
  splitSpectrumAtTime: (time: number) => void;
  ...
  saveNamedSnapshot: () => void;
  restoreSnapshotProject: (snapshotId: string) => void;
  applySnapshotDiffSelection: (selection: any) => void;
  ...
  deleteProxiesForMedia: (assetId: string) => Promise<void>;
  regenerateProxiesForMedia: (assetId: string) => Promise<void>;
  migrateProxiesToDirectory: (assetId: string) => Promise<void>;
  executeMacro: (macroId: string) => void;
  confirmProjectEncryptionSave: () => void;
  ...
  mergeDuplicateMediaGroups: (groups: any[]) => Promise<void>;
  refreshMediaHealthDashboard: () => Promise<void>;
  ...
  confirmMediaOrganizerDuplicateGroups: (selection: any) => Promise<void>;
  removeMediaOrganizerReferences: (selection: any) => Promise<void>;
  archiveUnusedMedia: (selection: any) => Promise<void>;
  renameUnusedMedia: (selection: any) => Promise<void>;
