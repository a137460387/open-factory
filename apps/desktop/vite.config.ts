      ...
      output: {
        manualChunks(id) {
          ...
          if (normalized.includes('/node_modules/@open-factory/editor-core/') || normalized.includes('/packages/editor-core/')) {
            // All editor-core modules in one chunk to avoid cross-chunk TDZ from source-level circular deps
            return 'editor-core';
          }
          // Split vendor into smaller chunks
          if (normalized.includes('/node_modules/')) {
            // React ecosystem
            if (normalized.includes('/node_modules/react/') || normalized.includes('/node_modules/react-dom/') || normalized.includes('/node_modules/react-dom/client') || normalized.includes('/node_modules/scheduler/')) return 'vendor-react';
            // State management
