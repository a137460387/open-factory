    ...
    <div className="space-y-2">
      {plugins.map((plugin, index) => (
        <a
          ...
          className="flex items-center gap-3 rounded-lg border border-[var(--border)] bg-[var(--surface-1)] p-3 transition-all hover:border-[var(--accent)]/20 hover:bg-[var(--surface-2)]"
        >
          {/* Rank */}
          <span
