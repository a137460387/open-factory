...
| 任务 | 负责人 | 工作量 | 风险 | 依赖 |
|------|--------|--------|------|------|
| H4.1: 创建 dialogStore.ts | 落小雨 | 2天 | 低 | 无 |
| H4.2: 创建 panelStore.ts | 落小雨 | 1天 | 低 | 无 |
| H4.3: 创建 toolbarStore.ts | 落小雨 | 1天 | 低 | 无 |
| H4.4: 创建 modalStore.ts | 落小雨 | 1天 | 低 | 无 |
| H4.5: 迁移 UI 组件引用 | 落小雨 | 3天 | 中 | H4.1-H4.4 |
| H4.6: 更新 E2E 测试 | 落小雨 | 1天 | 低 | H4.5 |
| H5.1: 创建 aiFeatureStore.ts | 落小雨 | 2天 | 低 | 无 |
| H5.2: 创建 exportFeatureStore.ts | 落小雨 | 1天 | 低 | 无 |
| H5.3: 创建 timelineFeatureStore.ts | 落小雨 | 1天 | 低 | 无 |
| H5.4: 迁移功能组件引用 | 落小雨 | 2天 | 中 | H5.1-H5.3 |
| H5.5: 更新 E2E 测试 | 落小雨 | 1天 | 低 | H5.4 |
