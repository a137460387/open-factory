import { DEFAULT_AUDIO_FADE_CURVE, DEFAULT_AUDIO_FADE_DURATION, DEFAULT_AUDIO_PITCH_SEMITONES, DEFAULT_AUDIO_REVERSE, DEFAULT_CHROMA_KEY, DEFAULT_CLIP_SPEED, DEFAULT_COLOR_CORRECTION, DEFAULT_TRANSFORM, DEFAULT_TRANSITION_DURATION, createId, createTransition, normalizeChromaKey, normalizeTransitionDuration, } from './model';
import { round } from './time';
export function buildVideoStitchSequence(segments, options) {
...
//# sourceMappingURL=video-stitching.js.map