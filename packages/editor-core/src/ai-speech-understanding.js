 ...
 */
export function understandSpeech(transcript, timeAlignment, options = {}) {
...
// ─── Keyword Extraction ────────────────────────────────────
function extractKeywords(tokens, maxKeywords, minFrequency) {
    // Count frequencies
...
// ─── Topic Extraction ──────────────────────────────────────
function extractTopics(keywords, maxTopics, timeAlignment) {
    ...
    for (const keyword of keywords) {
        ...
        for (const other of keywords) {
            if (usedKeywords.has(other.word))
                continue;
...
function areKeywordsRelated(word1, word2) {
...
function detectNarrativeMarkers(transcript, timeAlignment) {
    const markers = [];
...
//# sourceMappingURL=ai-speech-understanding.js.map