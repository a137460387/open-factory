 ...
 */
export function calculateClipImportance(clip, defaultScore = 0.5) {
 ...
 * the given tolerance.
 */
export function snapToSceneChange(time, sceneChangeTimes, tolerance = 0.5) {
 ...
 */
export function generatePlatformFitSuggestion(clips, limitSeconds, sceneChangeTimes, snapTolerance) {
...
//# sourceMappingURL=platform-fit.js.map