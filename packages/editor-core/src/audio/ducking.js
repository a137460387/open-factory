...
export function buildDuckingKeyframesForClip(clip, regions, options) {
    if (!('volume' in clip)) {
        return [];
    }
...
export function buildDuckingKeyframePlan(timeline, backgroundTrackId, regions, options) {
...
function inferSampleDuration(samples) {
...
function mergeDuckingRegions(regions, mergeGap) {
...
function toRoundedRegion(region) {
    return {
