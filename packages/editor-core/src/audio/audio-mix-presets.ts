...
export const BUILTIN_AUDIO_PRESETS: AudioMixPreset[] = [
  ...
  },
  {
    ...
    chain: [
      { id: 'ct-comp', effectType: 'compressor', enabled: true, params: { threshold: -24, ratio: 4, attack: 10, release: 100, makeup: 0 }, wetDry: 1, order: 0 },
      { id: 'ct-eq', effectType: 'eq-4band', enabled: true, params: { lowFreq: 80, lowGain: 4, lowMidFreq: 500, lowMidGain: -2, highMidFreq: 2000, highMidGain: 0, highFreq: 8000, highGain: 3 }, wetDry: 1, order: 1 },
      { id: 'ct-verb', effectType: 'reverb', enabled: true, params: { roomSize: 70, damping: 50, wetLevel: 30, dryLevel: 70, width: 100 }, wetDry: 1, order: 2 },
      { id: 'ct-lim', effectType: 'limiter', enabled: true, params: { threshold: -1, release: 50 }, wetDry: 1, order: 3 },
    ],
    createdAt: '2026-01-01T00:00:00Z',
    updatedAt: '2026-01-01T00:00:00Z',
  },
  {
    ...
    tags: ['voice', 'podcast'],
    chain: [
      { id: 'vo-hp', effectType: 'high-pass', enabled: true, params: { frequency: 80, resonance: 0.707 }, wetDry: 1, order: 0 },
      { id: 'vo-comp', effectType: 'compressor', enabled: true, params: { threshold: -18, ratio: 3, attack: 5, release: 80, makeup: 0 }, wetDry: 1, order: 1 },
      { id: 'vo-eq', effectType: 'eq-4band', enabled: true, params: { lowFreq: 80, lowGain: -2, lowMidFreq: 500, lowMidGain: 0, highMidFreq: 2000, highMidGain: 3, highFreq: 8000, highGain: 2 }, wetDry: 1, order: 2 },
      { id: 'vo-ds', effectType: 'de-esser', enabled: true, params: { frequency: 6000, threshold: -30, ratio: 4 }, wetDry: 1, order: 3 },
      { id: 'vo-lim', effectType: 'limiter', enabled: true, params: { threshold: -1, release: 50 }, wetDry: 1, order: 4 },
    ],
    createdAt: '2026-01-01T00:00:00Z',
    updatedAt: '2026-01-01T00:00:00Z',
  },
  {
    ...
    tags: ['live', 'music'],
    chain: [
      { id: 'lc-gate', effectType: 'gate', enabled: true, params: { threshold: -40, attack: 1, release: 100, range: -60 }, wetDry: 1, order: 0 },
      { id: 'lc-eq', effectType: 'eq-4band', enabled: true, params: { lowFreq: 80, lowGain: -3, lowMidFreq: 500, lowMidGain: 1, highMidFreq: 2000, highMidGain: 0, highFreq: 8000, highGain: 2 }, wetDry: 1, order: 1 },
      { id: 'lc-comp', effectType: 'compressor', enabled: true, params: { threshold: -20, ratio: 3, attack: 10, release: 100, makeup: 0 }, wetDry: 1, order: 2 },
      { id: 'lc-verb', effectType: 'reverb', enabled: true, params: { roomSize: 40, damping: 60, wetLevel: 20, dryLevel: 80, width: 100 }, wetDry: 1, order: 3 },
      { id: 'lc-lim', effectType: 'limiter', enabled: true, params: { threshold: -0.5, release: 50 }, wetDry: 1, order: 4 },
    ],
    createdAt: '2026-01-01T00:00:00Z',
    updatedAt: '2026-01-01T00:00:00Z',
  },
