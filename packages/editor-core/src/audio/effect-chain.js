...
export class EffectChainEngine {
     ...
     * 生成 FFmpeg 滤镜链
     */
    static toFfmpegFilters(effects) {
     ...
     * 描述 Web Audio 节点图
     */
    static describeNodeGraph(effects) {
    ...
    static effectToFfmpeg(type, params, wetDry) {
        switch (type) {
            case 'eq-4band':
                return {
