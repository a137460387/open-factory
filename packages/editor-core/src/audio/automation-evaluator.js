export function evaluateAutomation(automation, timeSeconds) {
    return {
        ...
        effectParams: automation
            ? Object.fromEntries(Object.entries(automation)
...
export function evaluateCurve(points, time, curveType) {
    if (!points.length)
        return 0;
    if (points.length === 1)
...
//# sourceMappingURL=automation-evaluator.js.map