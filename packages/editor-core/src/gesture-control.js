 ...
 */
export function recognizeSwipe(positions, velocityThreshold) {
 ...
 */
export function recognizePinch(distances, threshold) {
 ...
 */
export function processGestureEvent(event, state, mappings, config) {
 ...
 */
export function getGestureTutorialSteps() {
    return [
...
//# sourceMappingURL=gesture-control.js.map