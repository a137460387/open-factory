...
export type AudioChannelRoutingMode = 'normal' | 'mono-left' | 'mono-right' | 'mono-both' | 'swap-stereo' | 'stereo-left-mono' | 'stereo-right-mono' | 'stereo-to-mono';
...
export type TransitionType = 'fade-black' | 'dissolve' | 'wipe-left' | 'wipe-right' | 'wipe-up' | 'wipe-down' | 'zoom-dissolve' | 'flash-white' | 'flash-black' | 'block' | 'rotate' | 'film-roll-open' | 'film-roll-close' | 'shape-heart' | 'shape-star' | 'motion-blur-wipe' | 'push-left' | 'push-right' | 'push-up' | 'push-down' | 'light-leak' | 'glitch' | 'flip-horizontal' | 'flip-vertical' | 'cube-rotate' | 'portal';
...
export {};
//# sourceMappingURL=model-types-primitives.d.ts.map