const SNIFF_RULES = [
    ...
    },
    {
        ...
        extensions: ['.mp3'],
        label: 'MP3',
        match: (h) => (h.length >= 3 && h[0] === 0x49 && h[1] === 0x44 && h[2] === 0x33) ||
            (h.length >= 2 && h[0] === 0xff && (h[1] & 0xe0) === 0xe0),
    },
    {
        category: 'audio',
        extensions: ['.flac'],
...
export function classifyFileExtension(extension) {
    const videoExts = [
        '.mp4',
        '.m4v',
        '.mov',
...
export function sniffFileHeader(header, filename) {
...
//# sourceMappingURL=media-file-sniff.js.map