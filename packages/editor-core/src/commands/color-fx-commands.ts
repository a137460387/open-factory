import { createMask, normalizeClipBorder, normalizeMask, normalizeMasks, normalizeStabilization, normalizeTransform, type Clip, type ClipBorder, type ClipMask, type ClipStabilization, type Project, type Timeline } from '../model';
import type { ProjectPlatformFitSuggestion } from '../model-types';
...
import { type TimelineAccessor, type ProjectAccessor, findClip, findTrack, mergeChromaKeyPatch, isPiPVisualClip } from './helpers';
