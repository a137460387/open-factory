import type { BeatMarker, ClipGroup, CollaborationNote, ExportRange, MediaAsset, MediaFolder, MediaMetadata, Project, ProjectAnnotation, ProjectDocumentation, ProjectSettings, ProjectSpeaker, ProtectedRange, ReviewAnnotation, Sequence, Subclip, Timeline, TimelineBookmark, TimelineNote, TtsSegment } from '../model-types';
