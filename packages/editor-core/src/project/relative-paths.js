...
export function makeRelativePath(mediaPath, projectPath) {
    ...
    let shared = 0;
    while (shared < mediaParts.length &&
...
export function resolveMediaPath(asset, projectPath) {
...
export function isCrossDrivePath(left, right) {
...
function compareSegment(left, right, windows) {
    return windows ? left.toLowerCase() === right.toLowerCase() : left === right;
}
//# sourceMappingURL=relative-paths.js.map