...
export type PluginPermission = 'read-project' | 'write-project' | 'read-media' | 'export-hook' | 'menu-register' | 'timeline-mutation' | 'ai-inference' | 'network-access';
...
export interface EffectPlugin extends PluginLifecycle {
     ...
     */
    applyEffect(params: Record<string, unknown>, frameData: Uint8ClampedArray, width: number, height: number): Uint8ClampedArray | Promise<Uint8ClampedArray>;
    /**
...
export type AIModelCapability = 'scene-detection' | 'object-detection' | 'face-detection' | 'speech-to-text' | 'text-to-speech' | 'translation' | 'summarization' | 'style-transfer' | 'super-resolution' | 'noise-reduction' | 'custom';
/** AI model metadata. */
