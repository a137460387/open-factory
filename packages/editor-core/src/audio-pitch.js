...
export function analyzePitchFrames(samples, sampleRate, options = {}) {
...
export function pitchNoteColor(note) {
    return NOTE_COLORS[noteNameToPitchClass(note)] ?? '#94a3b8';
}
export function summarizePitchData(data) {
...
export function normalizeClipPitchData(data) {
...
export function serializePitchDataCsv(data) {
...
//# sourceMappingURL=audio-pitch.js.map