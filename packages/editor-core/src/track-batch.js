export function resolveTrackHeaderSelection(input) {
    ...
    const anchor = input.anchorTrackId && ordered.includes(input.anchorTrackId)
        ? input.anchorTrackId
...
export function moveSelectedTrackIds(orderedTrackIds, selectedTrackIds, draggedTrackId, targetTrackId) {
...
//# sourceMappingURL=track-batch.js.map