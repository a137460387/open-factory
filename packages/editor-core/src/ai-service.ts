...
import builtInProviderPresets, { type BuiltInProviderPreset } from './ai/ai-providers';

export type { BuiltInProviderPreset };

export const BUILT_IN_PROVIDER_PRESETS: BuiltInProviderPreset[] = builtInProviderPresets;
