...
export function getMediaCacheKey(input) {
...
export function buildCachePaths(kind, key) {
...
export function normalizeCachePath(path) {
...
export function isSafeCacheFileName(value) {
