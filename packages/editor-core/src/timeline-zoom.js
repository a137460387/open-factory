...
/** 各编辑模式的默认缩放偏好 */
export const ZOOM_MODE_DEFAULTS = {
...
export function zoomTimelineByWheel(currentZoom, deltaY, step = DEFAULT_TIMELINE_ZOOM_STEP) {
...
export function calculateAnchoredScrollLeft(input) {
...
export function ensurePlayheadVisible(input) {
...
export function fitTimelineZoomToWindow(duration, viewportWidth, labelWidth) {
...
export function zoomTimelineByGesture(currentZoom, gestureScale) {
 ...
 */
export function buildZoomContextKey(sequenceId, editMode) {
 ...
 */
export function resolveZoomForContext(zoomMemory, sequenceId, editMode) {
 ...
 */
export function saveZoomMemoryEntry(zoomMemory, sequenceId, editMode, zoomLevel) {
    const key = buildZoomContextKey(sequenceId, editMode);
 ...
 */
export function pruneZoomMemory(zoomMemory, validSequenceIds) {
    if (!zoomMemory) {
        return undefined;
    }
...
//# sourceMappingURL=timeline-zoom.js.map