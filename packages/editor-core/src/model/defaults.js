...
export function normalizeVfrHandlingStrategy(value) {
...
export const DEFAULT_STABILIZATION = {
    enabled: false,
    smoothing: 30,
    zoom: 0,
    analyzed: false,
...
export const FRAME_INTERPOLATION_TARGET_FPS = [24, 30, 48, 60, 120];
export const FRAME_INTERPOLATION_MODES = ['adaptive', 'blend', 'mci', 'copy'];
export const DEFAULT_FRAME_INTERPOLATION = {
    enabled: false,
    targetFps: 60,
    mode: 'adaptive',
    protectionFrames: 2,
};
export const CLIP_SLOW_MOTION_MODES = ['none', 'blend', 'mci', 'optical-flow'];
export const DEFAULT_SLOW_MOTION_MODE = 'none';
export const DEFAULT_CLIP_PROJECTION = 'flat';
export const DEFAULT_CLIP_PANORAMA_VIEW = {
    yaw: 0,
    pitch: 0,
    roll: 0,
    fov: 90,
...
export const VIDEO_TEMPORAL_DENOISE_PRESETS = {
...
export const DEFAULT_VIDEO_RESTORATION = {
...
export const DEFAULT_QUALITY_ENHANCEMENT = {
    superResolution: false,
    deblock: false,
    colorBoost: false,
    frameCompensation: false,
};
export const DEFAULT_AUDIO_DENOISE = {
    enabled: false,
    strength: 0.5,
};
export const DEFAULT_AI_LOCAL_DENOISE = {
    enabled: false,
    strength: 0.5,
};
export const DEFAULT_AUDIO_PITCH_SEMITONES = 0;
export const DEFAULT_AUDIO_REVERSE = false;
export const DEFAULT_AUDIO_FADE_CURVE = 'linear';
...
export const DEFAULT_PRIVACY_BLUR = {
    enabled: false,
    effect: 'pixelize',
    color: '#000000',
};
export const DEFAULT_CLIP_BORDER = {
    enabled: false,
    color: '#ffffff',
    width: 6,
};
...
export const DEFAULT_TRACK_COMPRESSOR = {
    enabled: false,
    threshold: -18,
    ratio: 3,
    attack: 10,
...
export const PROJECT_ANNOTATION_COLORS = ['#facc15', '#38bdf8', '#34d399', '#fb7185', '#a78bfa'];
export const TIMELINE_NOTE_COLORS = ['#facc15', '#38bdf8', '#34d399', '#fb7185', '#a78bfa', '#fb923c'];
...
export const DEFAULT_TEXT_PATH_POINTS = [
...
export const DEFAULT_TEXT_PATH = {
    enabled: false,
...
export const DEFAULT_SUBTITLE_MODE = 'burn-in';
export const DEFAULT_SUBTITLE_LANGUAGE = 'zh';
export const DEFAULT_SUBTITLE_TRACK_TYPE = 'subtitle';
