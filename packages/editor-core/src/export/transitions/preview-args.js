 ...
 */
export function buildTransitionThumbnailArgs(type, options = {}) {
...
export function getCanvasPreviewParams(type) {
    const base = { type, fade: false, zoom: false, rotate: false, pixelate: false, glitch: false };
    switch (type) {
        case 'dissolve':
...
//# sourceMappingURL=preview-args.js.map