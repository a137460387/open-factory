...
import type { AudioFadeCurve, AudioChannelRoutingMode, ClipBorder, ClipAudioRestoration, DataSubtitleSource, ClipFrameInterpolation, ClipMaskKeyframe, ClipPanoramaOutputProjection, ClipPrivacyBlur, ClipPrivacyRedaction, ClipProjection, ClipQualityEnhancement, ClipSlowMotionMode, ClipVideoRestoration, MotionTrackPoint, PathPoint, RichTextDocument, SubtitleTrackType, TextArcOptions, TextLayoutOptions, TextOpenTypeFeatures, TransitionType, TrackCompressor, TrackEQ, TrackEQBandType } from '../model';
...
export type ExportPlatformPreset = 'youtube-1080p' | 'youtube-shorts' | 'tiktok' | 'instagram-reels' | 'instagram-feed' | 'twitter-x' | 'bilibili' | 'weixin-channels' | 'kuaishou' | 'pinterest';
...
export type ExportWatermarkPosition = 'top-left' | 'top-center' | 'top-right' | 'middle-left' | 'center' | 'middle-right' | 'bottom-left' | 'bottom-center' | 'bottom-right';
...
export declare function buildStemOutputFileName(ctx: ExportStemNamingContext): string;
