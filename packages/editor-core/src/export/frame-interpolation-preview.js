export const FRAME_INTERPOLATION_COMPARE_MODES = [
    'original',
    'blend',
    'mci',
    'optical-flow',
];
export const FRAME_INTERPOLATION_ESTIMATE_COEFFICIENTS = {
    original: 0.3,
    blend: 0.9,
    mci: 1.8,
    'optical-flow': 2.4,
};
export function buildFrameInterpolationCompareArgs(mode, targetFps) {
...
export function estimateFrameInterpolationModeDurationMs(frameCount, mode) {
...
export function frameInterpolationCompareModeToSlowMotionMode(mode) {
    if (mode === 'blend') {
        return 'blend';
    }
    if (mode === 'mci') {
...
export function buildFrameInterpolationCompareFrameTimes(clipStart, clipDuration, playheadTime, fps) {
...
//# sourceMappingURL=frame-interpolation-preview.js.map