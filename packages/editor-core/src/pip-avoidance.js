 ...
 */
export function calculateBboxOverlap(bbox, rect) {
 ...
 */
export function evaluateCandidatePosition(subjectBbox, canvasW, canvasH, pipW, pipH, corner, margin = 0.025) {
...
const ALL_CORNERS = ['top-left', 'top-right', 'bottom-left', 'bottom-right'];
/**
 ...
 * proximity.
 */
export function suggestPipPlacement(subjectBboxes, canvasW, canvasH, pipW, pipH, margin) {
...
//# sourceMappingURL=pip-avoidance.js.map