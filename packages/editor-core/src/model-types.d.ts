 ...
 */
export type { KeyframeEasing, KeyframeHandleMode, KeyframeHandle, Keyframe, ClipKeyframes, KeyframeProperty, LUTLayer, PathPointHandle, PathPoint, MaskType, PrivacyBlurEffect, ClipMaskKeyframe, ClipPrivacyBlur, PrivacyRedactionType, RedactionKeyframe, ClipPrivacyRedaction, TimelineMarker, TimelineBookmark, BeatMarker, BookmarkGroup, BookmarkSortMode, ExportRange, ProtectedRange, ClipGroupColor, ClipGroup, TrackType, TimelineLabelColor, ChromaKeyColor, ChromaKeyMode, ChromaKey, ClipStabilization, FrameInterpolationTargetFps, FrameInterpolationMode, FrameInterpolationQualityGrade, FrameInterpolationQuality, ClipFrameInterpolation, ClipSlowMotionMode, ClipProjection, ClipPanoramaOutputProjection, ClipPanoramaView, VideoDenoisePreset, VideoDeinterlaceMode, ClipVideoDeinterlace, ClipVideoTemporalDenoise, ClipVideoSpatialDenoise, ClipVideoRestoration, ClipQualityEnhancement, MotionTrackPoint, AudioFadeCurve, AudioChannelRoutingMode, ClipAudioDenoise, ClipAILocalDenoise, ClipAudioRestoration, ClipAudioRestorationGap, TextStyle, TextBoxFitMode, RichTextRun, RichTextParagraph, RichTextDocument, TextLayoutOptions, TextOpenTypeFeatures, TextPathOptions, TextArcOptions, SubtitleMode, SubtitleLanguage, SubtitleTrackType, SubtitleStyle, DataSubtitleSourceType, DataSubtitleRow, DataSubtitleSource, TransitionType, Transition, Transform, ClipBorder, AssetType, MediaLabelColor, MediaFlag, MediaVersion, MediaFingerprintKind, MediaFingerprintAlgorithm, MediaFingerprint, MediaMetadata, MediaCollection, MediaFolder, ImageSequenceInfo, ProjectVersion, ZoomEditMode, VfrHandlingStrategy, ProjectDocumentation, ProjectSpeaker, ProjectAnnotation, ReviewAnnotationType, ReviewAnnotation, CollaborationNoteType, CollaborationNote, TimelineNote, MulticamSyncMode, SwitchTransition, SwitchPoint, MulticamAngle, MulticamSwitch, MulticamAiCutSuggestion, CreditsRow, CreditsStyle, WheelAdjustments, ClipAILookMatch, BeatSnapSuggestion, AiPipPlacementSuggestion, PlatformFitSegment, ProjectPlatformFitSuggestion, ClipPitchDataPoint, Subclip, ClipType, MulticamSequence, MulticamClipAngleBase, TrackEQBandType, TrackEQBand, TrackEQ, TrackCompressor, SequenceSettings, DubbingAdaptationType, TimingAdaptation, TtsSegment, CpmCurvePoint, PacingSegment, PacingAnalysis, ClipMask, Mask, } from './model-types-primitives';
...
export type DataSubtitleClip = SubtitleClip & {
    dataSubtitle: DataSubtitleSource;
};
