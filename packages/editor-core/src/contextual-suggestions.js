 ...
 */
export function suggestTransition(prevClip, nextClip, currentTime) {
 ...
 */
export function suggestPacingFix(timeline, currentTime) {
 ...
 */
export function suggestAudioFix(timeline, currentTime) {
 ...
 */
export function suggestContentImprovement(clip, media, currentTime) {
    if (clip.type !== 'video')
        return null;
    const mediaAsset = media.find((m) => m.id === clip.mediaId);
    if (!mediaAsset)
        return null;
 ...
 */
export function suggestHighlightMark(clip, currentTime) {
 ...
 */
export function generateContextualSuggestions(timeline, media, context, config = {}) {
 ...
 */
export function getSuggestionIcon(category) {
    const icons = {
...
//# sourceMappingURL=contextual-suggestions.js.map