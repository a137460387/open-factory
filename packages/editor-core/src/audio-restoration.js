...
export const DEFAULT_AUDIO_RESTORATION = {
    declip: { enabled: false },
    dereverb: { enabled: false, strength: 1 },
    dewind: { enabled: false },
    fill: { enabled: false },
};
export function normalizeAudioRestoration(restoration) {
    return {
...
export function buildAudioRestorationFilterChain(restoration, options = {}) {
    return buildAudioRestorationFilterArgs(restoration, options).join(',');
}
export function detectAudioFillGaps(gaps, threshold = AUDIO_FILL_GAP_THRESHOLD_SECONDS) {
...
export function buildAudioRestorationWaveformComparison(peaks, restoration) {
...
function formatAudioFilterNumber(value) {
...
//# sourceMappingURL=audio-restoration.js.map