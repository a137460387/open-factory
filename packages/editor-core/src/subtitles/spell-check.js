...
export const CHINESE_SPELL_CHECK_DICT = [
...
export const ENGLISH_SPELL_CHECK_DICT = [
...
export const DEFAULT_SPELL_CHECK_DICT = [...CHINESE_SPELL_CHECK_DICT, ...ENGLISH_SPELL_CHECK_DICT];
function escapeRegExp(value) {
    return value.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
}
export function scanSubtitleSpelling(inputs, dictionary = DEFAULT_SPELL_CHECK_DICT, glossary = []) {
...
export function applySpellCheckReplacement(text, result, replacement) {
...
export function buildSpellCheckReplacement(text, replaceInputs) {
    let result = text;
...
export function serializeSpellCheckReportCsv(results, options = {}) {
