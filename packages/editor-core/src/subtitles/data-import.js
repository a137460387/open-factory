...
export function parseSubtitleDataImport(contents, format) {
    return format === 'json' ? parseSubtitleDataJson(contents) : parseSubtitleDataCsv(contents);
}
export function parseSubtitleDataCsv(contents) {
...
export function parseSubtitleDataJson(contents) {
...
export function parseSubtitleDataTimecode(value) {
...
export function detectSubtitleDataOverlaps(cues) {
    const sorted = cues
...
export function mergeOverlappingSubtitleDataCues(cues) {
...
function csvRowToCue(row, rowNumber) {
    if (row.length < 3) {
...
function jsonEntryToCue(entry, rowNumber) {
...
function normalizeCue(input, label) {
...
function normalizeSubtitleStylePatch(value) {
