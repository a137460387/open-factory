import { DEFAULT_SUBTITLE_STYLE } from '../model';
export const SUBTITLE_STYLE_TEMPLATE_PREVIEW_TEXT = '示例字幕';
export const BUILTIN_SUBTITLE_STYLE_TEMPLATES = [
    {
        id: 'news-lower-third',
        kind: 'builtin',
        name: '新闻下三分之一',
...
export function normalizeSubtitleStyleTemplateStyle(style) {
    return {
...
export function renderSubtitleStyleTemplatePreview(template, text = SUBTITLE_STYLE_TEMPLATE_PREVIEW_TEXT) {
...
export function getBuiltinSubtitleStyleTemplate(id) {
...
//# sourceMappingURL=style-templates.js.map