import { round, secondsToTimecode } from '../time';
...
export function analyzeSubtitleProofreading(clips, settings = {}) {
...
export function calculateSubtitleReadingSpeed(text, duration, settings = {}) {
    const normalizedSettings = normalizeSubtitleProofreadingSettings(settings);
...
export function serializeSubtitleProofreadingCsv(issues, options = {}) {
...
export function normalizeSubtitleProofreadingSettings(settings = {}) {
...
function normalizeSubtitleProofreadingClips(clips) {
    return clips
...
function groupSubtitleClipsByTrack(clips) {
...
function createIssue(type, clip, extra = {}) {
    return {
...
//# sourceMappingURL=proofreading.js.map