...
export function getMaxCharsForText(text, config = DEFAULT_CONFIG) {
...
export function findBestBreakPoint(text, maxChars, config = DEFAULT_CONFIG) {
...
// ── Line Breaking ──────────────────────────────────────────────────────────
export function smartLineBreak(text, config = DEFAULT_CONFIG) {
...
function breakSingleLine(line, config) {
...
// ── Issue Detection ────────────────────────────────────────────────────────
export function detectLineBreakIssues(subtitles, config = DEFAULT_CONFIG) {
    const issues = [];
...
// ── Batch Re-break ─────────────────────────────────────────────────────────
export function batchRebreakSubtitles(subtitles, config = DEFAULT_CONFIG) {
...
// ── Preview ────────────────────────────────────────────────────────────────
export function previewLineBreak(text, config = DEFAULT_CONFIG) {
...
// ── Whisper Integration ────────────────────────────────────────────────────
export function applyLineBreakToWhisperOutput(text, config = DEFAULT_CONFIG) {
    return smartLineBreak(text, config);
}
export function normalizeLineBreakConfig(config) {
    return {
