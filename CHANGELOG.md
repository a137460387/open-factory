...
### Removed
- 10 dead workspace packages (zero production imports, zero dependency declarations):
  - packages/rbac (7 files)
  - packages/auth (9 files)
  - packages/audit-log (7 files)
  - packages/cloud-sync (6 files)
  - packages/ai-generator (15 files)
  - packages/api-gateway (22 files)
  - packages/collaboration-server (16 files)
  - packages/sdk (16 files)
  - packages/cli (18 files)
  - packages/plugin-cli (8 files)
- docker/ directory (no CI consumer, historical leftover):
  - Dockerfile, Dockerfile.gpu, README.md, docker-compose.yml
- Misplaced cross-package test: packages/editor-core/__tests__/personal-cloud.test.ts (tested cloud-sync/src/personal-cloud.ts via relative path)
...
- vitest.config.ts: removed alias/include/coverage entries for deleted packages
- tsconfig.json: removed references for deleted packages
- knip.json: removed entries for deleted packages
- .gitignore: removed outdated plugin-cli comment
- .github/workflows/ci.yml: removed dead paths-filter entry for docker/

### Metrics
- Tests: 12513 -> 12125 passed (-388), 3 skipped unchanged
- Lint warnings: 881 -> 788 (-93)
- Files removed: approximately 130 files, approximately 15,000 lines
